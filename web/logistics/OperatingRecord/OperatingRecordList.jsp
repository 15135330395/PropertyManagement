...
<div class="x-body">
    <div class="layui-row">
        <div class="layui-col-md12 x-so">
            <input type="text" name="incidentId" placeholder="请输入记录编号" autocomplete="off" class="layui-input">
        ...
        layui.use('table', function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {field: 'staffId', title: '人员编号'}
                    , {field: 'staffName', title: '借用人员'}
                    , {field: 'equipmentId', title: '器材编号'}
            ...
            layui.$('#search').on('click', function () {
                ...
                layer.open({
                    ...
                    area: ['451px', '405px'], // 宽高
                    content: '<%=request.getContextPath()%>/OperatingRecordServlet?action=findRecordByRecordId&recordId=' + val
                });
            });
