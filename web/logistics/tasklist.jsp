...
<div class="x-body">
    ...
    <script type="text/html" id="switchTpl">
        <input type="checkbox" name="sex" value="{{d.id}}" lay-skin="switch" lay-text="完成|未完成" lay-filter="sexDemo" {{ d.id == 10003 ? 'checked' : '' }}>
    </script>
        ...
        layui.use('table', function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {field: 'completion', title: '完成状况1', templet: '#checkboxTpl'}
                    , {field: 'completion', title: '完成状况2', templet: '#switchTpl'}
                    , {
                        field: 'completion',
                        title: '完成状况3',
