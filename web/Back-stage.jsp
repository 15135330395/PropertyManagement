...
<main class="page-content content-wrap">
    ...
    <div id="sidebar" class="page-sidebar sidebar">
        <div class="page-sidebar-inner slimscroll">
            <ul class="menu accordion-menu">
                ...
                <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-envelope-open"></span><p>协同办公</p><span class="arrow"></span></a>
                    <ul class="sub-menu">
    ...
    <div id="l_sidebar" class="left-sidebar" style="display: block">
        ...
        <div class="user_tab user_tab_left" id="user_tab_left_2">
            <h3 class="user_tab-title">基础资料</h3>
            ...
            <h3 class="user_tab-title">系统维护</h3>
        ...
        <div class="user_tab user_tab_left" id="user_tab_left_3">
            ...
            <h3 class="user_tab-title">流程管理</h3>
                <ul class="accordion-menu">
        ...
        <div class="user_tab user_tab_left" id="user_tab_left_5">
            ...
            <h3 class="user_tab-title">费用报表</h3>
                <ul class="accordion-menu">
        ...
        <div class="user_tab user_tab_left" id="user_tab_left_11">
            ...
            <h3 class="user_tab-title">安保消防</h3>
            <ul class="accordion-menu">
            ...
            <h3 class="user_tab-title">清洁绿化</h3>
            <ul class="accordion-menu">
        ...
        <div class="user_tab user_tab_left" id="user_tab_left_12">
            <h3 class="user_tab-title">合同管理</h3>
            <ul class="accordion-menu">
                <li><span class="menu-icon icon-user"></span>合同立项</li>
            </ul>
            <h3 class="user_tab-title">签报管理</h3>
            <ul class="accordion-menu">
                <li><span class="menu-icon icon-user"></span>签报管理</li>
            </ul>
            <h3 class="user_tab-title">设备管理</h3>
            <ul class="accordion-menu">
