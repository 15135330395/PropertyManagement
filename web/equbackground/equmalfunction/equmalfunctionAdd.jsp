    ...
    <form class="layui-form" action="">
        <%--<div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="hidden" name="mid" required  lay-verify="required"   autocomplete="off" class="layui-input">
            </div>
        </div>--%>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="handler" required lay-verify="required" placeholder="请输入处理人姓名" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">安装详情：</label>
            <div class="layui-input-inline">
                <input type="text" name="installdetail" lay-verify="required" class="layui-input" >
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">运行情况：</label>
            <div class="layui-input-inline">
                <input type="text" name="operation" lay-verify="required" class="layui-input"  >
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">保养情况：</label>
            <div class="layui-input-inline">
                <input type="text" name="maintenance" required lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">报废：</label>
            <div class="layui-input-inline">
                <input type="text" name="rejection" lay-verify="required" class="layui-input"  >
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
