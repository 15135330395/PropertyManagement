...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input value="${building.buildingName}" type="text" id="buildingName" name="buildingName" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input value="${building.staffId}" type="number" id="staffId" name="staffId" required="" lay-verify="number"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input  value="${building.areaId}" type="number" id="areaId" name="areaId" required="" lay-verify="number"
                        autocomplete="off" class="layui-input">
            </div>
        </div>
