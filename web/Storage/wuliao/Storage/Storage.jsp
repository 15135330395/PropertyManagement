    ...
    <script>
        ...
        layui.use('table', function(){
            ...
            table.render({
                elem: '#tab'
                //返回一个json字符串
                ,url:'<%=request.getContextPath()%>/StorageServlet?action=findAll'
                ,toolbar: '#toolbarDemao'
                ,title: '仓库明细'
                ,cols: [[
                    {type: 'checkbox', fixed: 'left'}
                    ,{field:'id', title:'仓库ID', width:'20%', fixed: 'left', sort: true}
                    ,{field:'principal', title:'负责人', width:'31%',}
                    ,{field:'contactPhone', title:'联系方式', width:'31%',}
            ...
            table.on('tool(test)', function(obj){
                ...
                if(obj.event === 'del'){
                    ...
                    $.ajax({
                        ...
                        data:"action=findOne&id="+data.id,
                        success:function (msg) {
