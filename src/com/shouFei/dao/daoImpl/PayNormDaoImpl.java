...
public class PayNormDaoImpl implements PayNormDao {
    ...
    public int deletePayNorm(int NormId) {
        ...
        try {
            int i = queryRunner.update(JdbcUtil.getConnection(), sql, NormId);
            return i;
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public int updatePayNorm(PayNorm payNorm) {
        ...
        try {
            int i = queryRunner.update(JdbcUtil.getConnection(), sql, payNorm.getPayName(), payNorm.getNormName(), payNorm.getComputeMode(),
