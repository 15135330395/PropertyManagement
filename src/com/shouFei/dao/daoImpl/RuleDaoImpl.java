...
public class RuleDaoImpl implements RuleDao {
    final static String colname="rule_id ruleId,plot_name plotName,room_number roomNumber,pay_name payName," +
            "norm_name normName,price,area,close_end closeEnd,riqi,money,money2,moneysum";
    ...
    public int updateRule(Rule rule) {
        ...
        try {
            int i = queryRunner.update(JdbcUtil.getConnection(), sql, rule.getPlotName(),rule.getRoomNumber(),rule.getPayName(),rule.getNormName()
