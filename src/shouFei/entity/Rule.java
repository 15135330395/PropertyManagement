...
public class Rule {
    ...
    public Rule(int ruleId, String plotName, String roomNumber, String payName, String normName, double price, double area, int closeEnd, Date riqi, double money, double money1, double money2, double moneysum) {
        this.ruleId = ruleId;
        this.plotName = plotName;
        this.roomNumber = roomNumber;
        this.payName = payName;
    ...
    public Rule( String plotName, String roomNumber, String payName, String normName, double price, double area, int closeEnd, Date riqi, double money, double money1, double money2, double moneysum) {
        this.plotName = plotName;
        this.roomNumber = roomNumber;
        this.payName = payName;
        this.normName = normName;
