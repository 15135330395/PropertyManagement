...
<script>
    layui.use('table', function() {
        ...
        table.render({
            elem: '#tab'
            // Servlet 返回一个json字符串
            , url: '<%=request.getContextPath()%>/BookServlet?action=queryPage'
            , toolbar: '#toolbarDemo'
            , title: '合同列表'
            , cols: [[
            ...
            switch(obj.event){
                ...
                case 'toadd':
                    ...
                    layer.open({
                        ...
                        offset: 'auto', //右下角弹出
                        anim: 2,
                        content: ['bookAdd.jsp'], //iframe的url，no代表不显示滚动条 , 'no'
            ...
            if(obj.event === 'del'){
                layer.confirm('真的删除行么', function(index){
                    ...
                    $.ajax({
                        ...
                        data:"action=delete&bId="+data.bId,
                        success:function(msg){
                            obj.del();
                            if(msg==0){
                ...
                layer.open({
                    ...
                    offset: 'auto', //右下角弹出
                    anim: 2,
                    content: ['<%=request.getContextPath()%>/BookServlet?action=queryOneBack&bId='+data.bId] //iframe的url，no代表不显示滚动条
